...
{
    public partial class Muhasebe : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ilçe = table.Column<string>(type: "text", nullable: true),
                    ...
                    ToplamBorc = table.Column<double>(type: "double precision", nullable: false),
                    ToplamAlacak = table.Column<double>(type: "double precision", nullable: false),
                    Bakiye = table.Column<double>(type: "double precision", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cari_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CariIslemlerID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    VadeTarihi = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ...
                    Aciklama = table.Column<string>(type: "text", nullable: true),
                    Borc = table.Column<double>(type: "double precision", nullable: false),
                    Alacak = table.Column<double>(type: "double precision", nullable: false),
                    GenelToplam = table.Column<double>(type: "double precision", nullable: false),
                    Odenen = table.Column<double>(type: "double precision", nullable: false),
                    islemTuru = table.Column<int>(type: "integer", nullable: false),
                    CariId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CariIslemler", x => x.CariIslemlerID);
                    table.ForeignKey(
                        name: "FK_CariIslemler_Cari_CariId",
                        column: x => x.CariId,
                        principalTable: "Cari",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    kdvDurum = table.Column<int>(type: "integer", nullable: false),
                    iskontoTuru = table.Column<int>(type: "integer", nullable: false),
                    Toplam = table.Column<double>(type: "double precision", nullable: false),
                    GenelToplam = table.Column<double>(type: "double precision", nullable: false),
                    IslemID = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Urun", x => x.UrunID);
                    table.ForeignKey(
                        name: "FK_Urun_CariIslemler_IslemID",
                        column: x => x.IslemID,
                        principalTable: "CariIslemler",
                        principalColumn: "CariIslemlerID",
                        onDelete: ReferentialAction.Restrict);
                });
